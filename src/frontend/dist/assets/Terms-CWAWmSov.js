import { j as jsxRuntimeExports, m as motion, L as Link, C as ChevronRight, F as FileText } from "./index-lv5lHg54.js";
import { G as GlowCard, A as AnimatedSection } from "./GlowCard-DyOrzrAz.js";
...
const GLOW_COLORS = ["violet", "cyan", "magenta"];
function TermsPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-16 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-violet-600/8 via-background to-cyan-500/8 pointer-events-none" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.nav,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-violet-400", children: "Terms & Conditions" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-violet-500/10 flex items-center justify-center shrink-0 neon-border-violet", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-8 h-8 text-violet-400" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-bold uppercase tracking-widest text-violet-400 mb-3 px-3 py-1 rounded-full border border-violet-400/30 bg-violet-400/5", children: "Legal" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-4", children: [
                      "Terms &",
                      " ",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text-cyan-violet", children: "Conditions" })
                    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-4 gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-24", "data-ocid": "terms.toc.panel", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(GlowCard, { glowColor: "violet", className: "p-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-sm font-bold uppercase tracking-widest text-violet-400 mb-4", children: "Contents" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-3 space-y-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(GlowCard, { glowColor: "cyan", className: "p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed text-sm", children: "Welcome to Arthashastra Classes. These Terms & Conditions govern your use of our educational platform, website, and services. Please read them carefully before enrolling in any course or using any feature of our platform." }) }) }),
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(GlowCard, { glowColor: GLOW_COLORS[i % 3], className: "p-8", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-xl font-bold text-foreground mb-5 flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `w-7 h-7 rounded-lg flex items-center justify-center text-xs font-extrabold shrink-0 ${i % 3 === 0 ? "bg-violet-500/10 text-violet-400" : i % 3 === 1 ? "bg-cyan-500/10 text-cyan-400" : "bg-fuchsia-500/10 text-fuchsia-400"}`,
                        children: i + 1
                      }
                    ),
                    section.title
